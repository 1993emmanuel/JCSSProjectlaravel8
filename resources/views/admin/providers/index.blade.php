...
<li class="nav-item d-none d-lg-block">
	<a href="{{route('providers.create')}}" class="nav-link">
		<span class="btn btn-primary"><i class="fa fa-plus" aria-hidden="true"></i> Crear Proveedor</span>
	</a>
</li>
@endsection
@section('options')
	...
	<div class="content-wrapper">
		...
		<nav arial-label="breadcrumb">
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item active" aria-current="page">Todas los Proveedores</li>
			</ol>
		</nav>
		<div class="row">
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <div class="btn-group">
                            	...
                            	<div class="dropdown-menu dropdown-menu-right">
                            		<a href="{{route('providers.create')}}" class="dropdown-item" type="button">Crear</a>
                            	</div>
                            </div>
                        </div>
